...
def game():
    ...
    while run:
        ...
        if config.bullet1appear:
            ...
            bullet1 = pygame.Rect(config.bullet1_x + config.player_size/2, config.bullet1_y + config.player_size/2, 6, 6)
        ...
        # With the blue tank
        if tanks.player_2_x + config.player_size >= config.bullet1_x >= tanks.player_2_x and tanks.player_2_y + config.player_size >= config.bullet1_y >= tanks.player_2_y or tanks.player_2_x - config.player_size >= config.bullet1_x >= tanks.player_2_x and tanks.player_2_y - config.player_size >= config.bullet1_y >= tanks.player_2_y:
            config.bullet1_hit = 0
            config.bullet1_x = tanks.player_1_x
        ...
        if tanks.player_3_x + config.player_size >= config.bullet1_x >= tanks.player_3_x and tanks.player_3_y + config.player_size >= config.bullet1_y >= tanks.player_3_y or tanks.player_3_x - config.player_size >= config.bullet1_x >= tanks.player_3_x and tanks.player_2_y - config.player_size >= config.bullet1_y >= tanks.player_2_y:
            config.bullet1_hit = 0
            config.bullet1_x = tanks.player_1_x
            config.bullet1_y = tanks.player_1_x
            config.bullet1appear = False
            ...
            config.score_p1_text = config.score_p1_font.render(f'{config.score_p1}', True, config.Green)
        # with the red player
        if tanks.player_4_x + config.player_size >= config.bullet1_x >= tanks.player_4_x and tanks.player_4_y + config.player_size >= config.bullet1_y >= tanks.player_4_y or tanks.player_4_x - config.player_size >= config.bullet1_x >= tanks.player_4_x and tanks.player_4_y - config.player_size >= config.bullet1_y >= tanks.player_4_y:
            config.bullet1_hit = 0
            config.bullet1_x = tanks.player_1_x
            config.bullet1_y = tanks.player_1_x
            config.bullet1appear = False
        ...
        # with the green tank
        if tanks.player_1_x + config.player_size >= config.bullet2_x >= tanks.player_1_x and tanks.player_1_y + config.player_size >= config.bullet2_y >= tanks.player_1_y or tanks.player_1_x - config.player_size >= config.bullet2_x >= tanks.player_1_x and tanks.player_1_y - config.player_size >= config.bullet2_y >= tanks.player_1_y:
            config.bullet2_hit = 0
            config.bullet2_x = tanks.player_2_x
            config.bullet2_y = tanks.player_2_y
            config.bullet2appear = False
            ...
            # with the purple tank***apagar e colar desde essa parte pq tinha um erro
        if tanks.player_3_x + config.player_size >= config.bullet2_x >= tanks.player_3_x and tanks.player_3_y + config.player_size >= config.bullet2_y >= tanks.player_3_y or tanks.player_3_x - config.player_size >= config.bullet2_x >= tanks.player_3_x and tanks.player_3_y - config.player_size >= config.bullet2_y >= tanks.player_3_y:
            config.bullet1_hit = 0
            config.bullet2_x = tanks.player_2_x
        ...
        # with the red player
        if tanks.player_4_x + config.player_size >= config.bullet2_x >= tanks.player_4_x and tanks.player_4_y + config.player_size >= config.bullet2_y >= tanks.player_4_y or tanks.player_4_x - config.player_size >= config.bullet2_x >= tanks.player_4_x and tanks.player_4_y - config.player_size >= config.bullet2_y >= tanks.player_4_y:
            config.bullet2_hit = 0
            config.bullet2_x = tanks.player_2_x
            config.bullet2_y = tanks.player_2_x
            config.bullet2appear = False
        ...
        # with the green tank
        if tanks.player_1_x + config.player_size >= config.bullet3_x >= tanks.player_1_x and tanks.player_1_y + config.player_size >= config.bullet3_y >= tanks.player_1_y or tanks.player_1_x - config.player_size >= config.bullet3_x >= tanks.player_1_x and tanks.player_1_y - config.player_size >= config.bullet3_y >= tanks.player_1_y:
            config.bullet3_hit = 0
            config.bullet3_x = tanks.player_3_x
            config.bullet3_y = tanks.player_3_y
            config.bullet3appear = False
        ...
        if tanks.player_2_x + config.player_size >= config.bullet3_x >= tanks.player_2_x and tanks.player_2_y + config.player_size >= config.bullet3_y >= tanks.player_2_y or tanks.player_2_x - config.player_size >= config.bullet3_x >= tanks.player_2_x and tanks.player_2_y - config.player_size >= config.bullet3_y >= tanks.player_2_y:
            config.bullet3_hit = 0
            config.bullet3_x = tanks.player_3_x
            ...
            config.score_p3_text = config.score_p3_font.render(f'{config.score_p3}', True, config.Purple)
            # with the red player
        if tanks.player_4_x + config.player_size >= config.bullet3_x >= tanks.player_4_x and tanks.player_4_y + config.player_size >= config.bullet3_y >= tanks.player_4_y or tanks.player_4_x - config.player_size >= config.bullet3_x >= tanks.player_4_x and tanks.player_4_y - config.player_size >= config.bullet3_y >= tanks.player_4_y:
            config.bullet2_hit = 0
            config.bullet3_x = tanks.player_3_x
            config.bullet3_y = tanks.player_3_x
            config.bullet3appear = False
        ...
        # Red tank bullet collision
        # with the green tank
        if tanks.player_1_x + config.player_size >= config.bullet4_x >= tanks.player_1_x and tanks.player_1_y + config.player_size >= config.bullet4_y >= tanks.player_1_y or tanks.player_1_x - config.player_size >= config.bullet4_x >= tanks.player_1_x and tanks.player_1_y - config.player_size >= config.bullet4_y >= tanks.player_1_y:
            config.bullet4_hit = 0
            config.bullet4_x = tanks.player_4_x
            config.bullet4_y = tanks.player_4_y
            config.bullet4appear = False
        ...
        # With the blue tank
        if tanks.player_2_x + config.player_size >= config.bullet4_x >= tanks.player_2_x and tanks.player_2_y + config.player_size >= config.bullet4_y >= tanks.player_2_y or tanks.player_2_x - config.player_size >= config.bullet4_x >= tanks.player_2_x and tanks.player_2_y - config.player_size >= config.bullet4_y >= tanks.player_2_y:
            config.bullet4_hit = 0
            config.bullet4_x = tanks.player_4_x
            config.bullet4_y = tanks.player_4_x
            config.bullet4appear = False
            config.score_p4 += 1
            player2_damaged = pygame.Rect(tanks.player_2_x, tanks.player_2_y, 120, 120)
            pygame.draw.rect(Background.screen, config.Red, player2_damaged)
        ...
        # with the purple tank
        if tanks.player_3_x + config.player_size >= config.bullet4_x >= tanks.player_3_x and tanks.player_3_y + config.player_size >= config.bullet4_y >= tanks.player_3_y or tanks.player_3_x - config.player_size >= config.bullet4_x >= tanks.player_3_x and tanks.player_3_y - config.player_size >= config.bullet4_y >= tanks.player_4_y:
            config.bullet4_hit = 0
            config.bullet4_x = tanks.player_4_x
            config.bullet4_y = tanks.player_4_x
            config.bullet4appear = False
        ...
        # Purple player's bullet's movement if it is triggered
        ...
        # Red player's bullet's movement if it is triggered
        if config.bullet4appear:
            ...
            pygame.draw.rect(Background.screen, config.Redd, config.bullet4)
        ...
        config.bullet2_x, config.bullet2_y = collision.detect_collision_ball1(config.bullet2_x, config.bullet2_y)
        config.bullet3_x, config.bullet3_y = collision.detect_collision_ball1(config.bullet3_x, config.bullet3_y)
        config.bullet4_x, config.bullet4_y = collision.detect_collision_ball1(config.bullet4_x, config.bullet4_y)
        ...
        if config.score_p1 == 5 or config.score_p2 == 5 or config.score_p3 == 5 or config.score_p4 == 5:
            run = False
